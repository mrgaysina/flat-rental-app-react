  ...
  return (
    <Box>
      {/* <div>
        {mytrips.map((mytrip) => {
          return (
            <div>{mytrip.startDate.toLocaleString().slice(0,-14)}</div>
          ); //поездки
        })}
      </div> */}
      {/*<div>
        {favorites.map((favorite) => {
          return <div>{favorite['Flats.address']}</div>;  //любимое
        })}
      </div>
      <div>
        {myflats.map((myflats) => {
          return <div>{myflats.address}</div>;   //мои квартиры
        })}
      </div> */}
                    ...
                    >
                      <div className="container__rate">
                        <Typography
                          ...
                          align="left"
                        >
                          {favorite['Flats.country']}, {favorite['Flats.city']}
                        </Typography>
                        <div
                          style={{
                            display: 'flex',
